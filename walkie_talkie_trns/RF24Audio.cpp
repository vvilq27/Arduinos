...
void RF24Audio::begin(){
  ...
  radio.openWritingPipe(pipes[1]);     // Set up reading and writing pipes. All of the radios write via multicast on the same pipe
  radio.openReadingPipe(1,pipes[0]);   // All of the radios listen by default to the same multicast pipe
